...
{
    [TestClass]
    public class PredicateMetaActionsTests
    {
        [TestMethod]
        ...
        public void Can_GenerateCorrectAmount(string domainFile, int expected, params string[] problemFiles)
        {
            ...
            var generator = MetaGeneratorBuilder.GetGenerator(MetaGeneratorBuilder.GeneratorOptions.Predicate, domain, problems, new Dictionary<string, string>());
